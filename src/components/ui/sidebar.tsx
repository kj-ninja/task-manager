...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // This sets the cookie to keep the sidebar state.s
      // biome-ignore lint/suspicious/noDocumentCookie: shadcn generated code uses direct cookie assignment
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: setOpen and setOpenMobile are stable from useState
